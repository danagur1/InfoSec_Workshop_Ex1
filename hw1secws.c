...
static void set_forward_hook(void){
	...
	nf_register_net_hook(&init_net, &forward_nh_ops);
}

static void set_input_hook(void){
	...
	nf_register_net_hook(&init_net, &input_nh_ops);
}

static void set_output_hook(void){
	...
	nf_register_net_hook(&init_net, &output_nh_ops);
}
